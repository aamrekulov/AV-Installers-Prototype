  ...
  return (
    <section className="relative min-h-[100dvh] flex items-center bg-[#080a0c] overflow-hidden">
      ...
      <div className="relative z-10 w-full py-16 px-5 lg:py-28 lg:px-20 xl:px-28">
        ...
        >
          <span className="font-sans text-[0.65rem] uppercase tracking-[0.22em] text-white/75 mb-8 block">
            {eyebrow}
          </span>
          <h1 className="font-display font-light text-white leading-[1.05] tracking-[-0.02em] text-[clamp(2.8rem,5vw,4.6rem)] mb-8">
            {heading}
          </h1>
          <p className="text-white/65 text-xl font-light leading-[1.8] mb-12">{description}</p>
          <div className="flex flex-wrap gap-4">
            <a
              href={`#${primaryCta.targetId}`}
              className="inline-flex items-center gap-2.5 px-8 py-4 rounded-full border border-white/25 text-white text-[0.8rem] uppercase tracking-[0.14em] font-semibold transition-all duration-300 hover:border-white/60 hover:bg-white/5 group"
            ...
            {secondaryCta && (
              <a
                ...
                className="inline-flex items-center gap-2.5 px-8 py-4 rounded-full border border-white/25 text-white text-[0.8rem] uppercase tracking-[0.14em] font-medium transition-all duration-300 hover:border-white/60 hover:bg-white/5"
